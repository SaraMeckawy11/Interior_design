...
FURNITURE_BY_ROOM = {
    "living room": (
        f"{_st['sofa']}, two matching armchairs beside the sofa, "
        f"{_st['table']}, and a media console with a TV above it"
    ),
    "bedroom": (
...
prompt = (
    ...
    f"- FULLY FINISH: {_st['floor']} floor, smooth painted walls, clean "
    ...
    f"{_st['lamp']}, {_st['ceiling']}, layered cushions, books and "
    "ceramics ONLY on the table.\n"
    f"- Curtains: {_st['curtains']}, from a recessed ceiling slot, NO rod "
    "or gap, spanning the window wall to the floor.\n"
    ...
    "behind it. Few high-quality decor pieces, generous open space; "
    "corners MAY stay empty; never crowd two items into one spot; plants "
    "NEVER stand in front of or overlap furniture, matching plants match "
    "in size, no rod or pole behind any plant; nothing blocks windows, "
    "doors or walkways; furniture square to walls; floor and rug CLEAR "
    "of books and papers.\n"
    f"- COLOR 60/30/10: DOMINANT 60% {COLOR_TONE} on "
    "walls, ceiling, curtains and rug; SECONDARY 30% one deeper "
    "harmonizing shade on sofa, armchairs and large upholstery; ACCENT "
    "10% ONE bold contrasting color ONLY on cushions, art and small "
    f"decor; {_st['textures']}.\n"
